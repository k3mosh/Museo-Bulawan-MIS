...
const UserView = ({ userId, onClose }) => {
  ...
  return (
    <div className="w-screen h-screen fixed backdrop-blur-xs z-50 flex items-center justify-center">
      {showConfirmation && (
        <ConfirmationModal
          title="Save Changes?"
      ...
      <div className="w-[43rem] min-h-fit bg-[#1C1B19] border-1 border-[#3A3A3A] flex flex-col rounded-sm">
        <div className="w-full min-h-15 bg-[#373737] flex justify-between">
          <div className="h-15 w-fit flex items-center px-5">
            <span className="text-2xl text-white font-semibold">User</span>
          </div>
        ...
        <div className="w-full h-full flex flex-col p-6 gap-y-2">
          <div className="w-full flex justify-between min-h-15">
            <div className="flex flex-col w-75 gap-y-2">
              <label htmlFor="first-name" className="text-xl text-white font-semibold">
                First Name
              </label>
              <input
                ...
                className="bg-[#242424] w-full h-15 rounded-sm border-[#373737] border px-4 text-lg text-white font-semibold"
              />
            </div>

            <div className="flex flex-col w-75 gap-y-2">
              <label htmlFor="last-name" className="text-xl text-white font-semibold">
                Last Name
              </label>
              <input
          ...
          <label htmlFor="position" className="text-xl text-white font-semibold">
            Position
          </label>
          <input
          ...
          <div className="flex flex-col gap-y-2">
            <label htmlFor="old-password" className="text-xl text-white font-semibold">
              Old Password
            </label>
            <div className="relative">
              <input
                ...
                className="bg-[#242424] w-full h-15 rounded-sm border-[#373737] border px-4 pr-12 text-lg text-white font-semibold"
              />
              <button
                type="button"
              ...
              >
                <i className={`cursor-pointer fa-solid ${showOldPassword ? 'fa-eye-slash' : 'fa-eye'}`}></i>
              </button>
            </div>

            <label htmlFor="new-password" className="text-xl text-white font-semibold">
              New Password
            </label>
            <div className="relative">
              <input
              ...
              >
                <i className={`cursor-pointer fa-solid ${showNewPassword ? 'fa-eye-slash' : 'fa-eye'}`}></i>
              </button>
            </div>

            <label htmlFor="re-password" className="text-xl text-white font-semibold">
              Confirm Password
            </label>
            <div className="relative">
              <input
              ...
              >
                <i className={`cursor-pointer fa-solid ${showRePassword ? 'fa-eye-slash' : 'fa-eye'}`}></i>
              </button>
            </div>

            {/* Role Selection */}
            <div className="w-full flex flex-col gap-y-2 text-white">
              <span className="block text-xl font-semibold text-white">Role</span>
              ...
              <label className="flex items-start gap-4 p-4 rounded-md border border-gray-600 cursor-pointer hover:border-purple-500">
                ...
                />
                <div>
                  <span className="block text-lg font-semibold">Administrator</span>
              ...
              <label className="flex items-start gap-4 p-4 rounded-md border border-gray-600 cursor-pointer hover:border-purple-500">
                ...
                <div>
                  ...
                  <span className="text-sm text-gray-400">
                    Staff members cannot view logs and edit users. Reviewers can manage all transactions.
                  </span>
                </div>
              </label>
            </div>
        ...
        <div className="w-full min-h-15 bg-[#373737] flex px-5 justify-end">
          <div className="w-fit h-15 flex items-center gap-x-2">
            <button
              onClick={onClose}
              className="w-30 h-8 bg-[#3A3A3A] border flex items-center justify-center border-white rounded cursor-pointer"
            >
