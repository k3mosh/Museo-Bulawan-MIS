    ...
    <>
      <div className='w-screen min-h-[79.8rem] h-screen bg-[#F0F0F0] flex pt-[7rem]'>
        <div className='bg-[#1C1B19] w-auto min-h-full h-auto min-w-[6rem] sm:min-w-auto'>
          ...
          <div className='w-full h-full min-h-[72rem] p-10 md:p-10'>
                            ...
                            <div className='w-full h-1/2 bg-black p-2 flex flex-col shadow-lg'>
                              <div className="w-full h-full flex flex-col justify-start items-center">
                                ...
                                <div className="w-full h-1/5 text-[#EAC39C] font-bold flex items-center justify-center">
                                  <span className="w-full flex items-center justify-start pl-1 text-md md:text-3xl  md:pl-8">Compared to last month (1486)</span>
                                </div>
                              </div>
                            </div>
                            <div className='w-full h-1/2 bg-black p-2 flex flex-col shadow-lg'>
                              <div className="w-full h-full flex flex-col justify-start items-center">
                                ...
                                <div className="w-full h-1/5 text-[#EAC39C] font-bold flex items-center justify-center">
                                  <span className="w-full flex items-center justify-start pl-1 text-md md:text-3xl md:pl-8">Compared to last month (80)</span>
                                </div>
                              </div>
                            </div>
                          </div>                      
